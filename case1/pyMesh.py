"""
PhyGeoNet: Physics-Informed Geometry-Adaptive Convolutional Neural Networks for Solving Steady-State Parametric PDEs on Irregular Domain
...
def visualize2D(ax,x,y,u,colorbarPosition='vertical',colorlimit=None,fraction=0.08, pad=0.25):
	...
	#ax.set_aspect('equal')
	# cbar=plt.colorbar(polygon_ensemble,orientation=colorbarPosition,fraction=0.05, pad=0.1)
	cbar=plt.colorbar(polygon_ensemble,orientation=colorbarPosition,fraction=fraction, pad=pad)
