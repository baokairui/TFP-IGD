...
class LayoutDataset(Dataset): 
    def __init__(self,train=True):
        data_input1 = sio.loadmat('./dataset/2500/bound/boundx1')['b']
        data_input2 = sio.loadmat('./dataset/2500/bound/boundy1')['b']
        data_output1 = sio.loadmat('./dataset/2500/mesh/meshx1')['b']
        data_output2 = sio.loadmat('./dataset/2500/mesh/meshy1')['b']
        ...
        if train:
            self.F = data_input[:2000]
            self.u = data_output[:2000]
        else:
            self.F = data_input[2000:]
            self.u = data_output[2000:]
    def __len__(self):
...
for epoch in range(num_epochs):
    ...
    if loss < best_loss:
        best_loss = loss
        torch.save(net.state_dict(),"path/DeepLearning/best_mesh_data.pth")