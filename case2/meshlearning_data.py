...
class LayoutDataset(Dataset): 
    def __init__(self,train=True):
        ...
        data_output1 = sio.loadmat('./dataset/2000/meshx/meshx1')['b']
        data_output2 = sio.loadmat('./dataset/2000/meshy/meshy1')['b']
...
for epoch in range(num_epochs):
    ...
    if loss < best_loss:
        best_loss = loss
        torch.save(net.state_dict(),"path/Mesh/best_mesh_data.pth")