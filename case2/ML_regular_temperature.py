...
def solve(nx,ny,data_path1,data_path2,data_path3,level):
...
if __name__ == '__main__':
    for i in range(1,5):
        ...
        level = 5 - i
        name = 500 * i
        solve(nx,ny,'./dataset/2000/alpha/alpha'+str(level),'./dataset/2000/beta/beta'+str(level),'./dataset/2000/gamma/gamma'+str(level),level)
