...
tr_writer = SummaryWriter(log_dir="runs/mesh_phy/train")
te_writer = SummaryWriter(log_dir="runs/mesh_phy/test")
...
optimizer = optim.Adam(net.parameters(), lr=0.003, betas=(0.9, 0.999), eps=1e-08, weight_decay=0, amsgrad=False)
...
for epoch in range(num_epochs):
    ...
    if loss < best_loss:
        best_loss = loss
        torch.save(net.state_dict(),"path/DeepLearning/best_mesh_phy.pth")